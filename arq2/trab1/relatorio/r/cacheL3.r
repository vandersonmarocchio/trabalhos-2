file_name <- "cacheL3.png"
title <- "Aumento da Taxa de Miss da Cache L3 em relação a Arquitetura 1"
x_label <- "Programas"
y_label <- "% de aumento"

arquitetura1 <- c(10.456, 10.361, -4.26, -1.595, 12.218, 0.861, 9.244, 1.897, 5.441, 0.785)
